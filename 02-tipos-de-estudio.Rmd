...
a poblaciones (caso anemia) y causal (policías). En el caso ideal de cada uno de
estos ejemplos requerimos un mecanismo de aleatorización distinto y esto es 
fundamental para entender las inferencias que podemos hacer.
