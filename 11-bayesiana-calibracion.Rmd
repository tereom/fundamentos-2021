...
funciones de pérdida, pero como en secciones anteriores, usaremos la **pérdida
...
La respuesta es que bajo un enfoque frecuentista podemos tomar cualquiera de las 
tres alternativas: 
- Admisibilidad. Una decision inadmisible es aquella que es dominada por otra en
cualquier valor de $\theta$.
- Restringir la clase de estimadores. 
