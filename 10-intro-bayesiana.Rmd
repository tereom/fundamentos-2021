...
$(1-\alpha)$ si
$$ \int_{I}^{} \mathbb{P}(\theta)d\theta = 1 - \alpha\,.$$
...
Se denotamos por $p_0 = \mathbb{P}(H_0)$ la probabildiad asociada a la hipótesis $H_0$
al momento de tomar una decisión. Entonces la pérdida esperada para cada decisión
es
\begin{gather}
