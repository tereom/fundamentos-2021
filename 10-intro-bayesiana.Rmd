...
$$\mathbb{P}(X_1,\ldots, X_n|\theta) = \theta^{-n} 1_{[X_\max,\infty)}(\theta)\,,$$
...
$$\mathbb{P}(\theta|X_1,\ldots, X_n |\theta) \propto \theta^{-(n + 2.1)} \left(1_{[X_\max,\infty]}(\theta)  \times 1_{[\theta_0,\infty]}(\theta)\right) \,,$$
