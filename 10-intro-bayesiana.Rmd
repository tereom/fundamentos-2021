...
Independiente del método utilizado, la incertidumbre que hemos aprendido a 
incorporar en nuestros estimadores ha seguido el espirítu frecuentista. Es decir, 
nuestra incertidumbre la hemos incorporado bajo distinats realizaciones
hipotéticas de nuestro conjunto de datos. Estás realizaciones las hemos simulado 
considerando el proceso generador de datos, o aproximaciones razonables a éste.  

La inferencia bayesiana tiene por objetivo incorporar incertidumbre en nuestras
estimaciones. Sin embargo, la incertidumbre en el contexto bayesiano se deriva
...
1. Nótese que este último ejemplo tienen más de un parámetro. En estos casos, el
