...
con la que hacemos los lanzamiento es una variable aleatoria. ¡Pero esto es un
...
Ahora escribiremos las funciones predictivas (previa y posterior) en
este caso.  Primero notemos lo siguiente. La previa corresponde a una
variable aleatoria Beta y la posterior también. Esto aliviará nuestros 
cálculos. 
