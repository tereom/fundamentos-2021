...
Se denotamos por $p_0 = P(H_0)$ la probabildiad asociada a la hipótesis $H_0$
...
en las ecuaciones de arriba sólo hemos utilizado $P(H_0)$. Es decir,
...
la distribución posterior de $H_0$ una vez observados los datos $P(H_0|X)$.

Suponiendo que los costos de no equivocarnos son 0, entonces escogeríamos $H_0$ si
y sólo si
\begin{align}
\frac{P(H_0|X)}{P(H_1|X)} < \frac{v_{0,1}}{v_{1,0}}\,.
\end{align}
Lo cual es equivalente a
\begin{align}
\frac{P(X|H_0)}{P(X|H_1)} < \frac{P(H_1)}{P(H_0)} \times \frac{v_{0,1}}{v_{1,0}}\,,
\end{align}
